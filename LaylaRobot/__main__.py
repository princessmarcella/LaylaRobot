...
Powered by :- [Godseye](t.me/dragonqueen_music)"""

layla_IMG = "https://telegra.ph/file/53ec2d560df37d380e1e3.jpg"

DONATE_STRING = """wait please."""
...
def layla_about_callback(update, context):
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text="""  I'm God's eye, a powerful group management bot built to help you manage your group easily.
